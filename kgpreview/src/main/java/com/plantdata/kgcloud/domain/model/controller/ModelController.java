...
public class ModelController {
    ...
    public ApiReturn test(@ApiParam("接口路径") String path,
        ...
        //structService.test(path, type, ip, port, database, userName, pwd);
    ...
    public ApiReturn<Page<String>> getTableName(@ApiParam("接口路径") String path,
        ...
        //RestData rs = structService.getTables(path, type, ip, port, database, userName, pwd, kw, pageNo, pageSize);
        return ApiReturn.success();
    }
    ...
    public ApiReturn<List<TableSchemaRsp>> getTableSchema(@ApiParam("接口路径") String path,
        ...
        // RestData rs = structService.r(path, type, ip, port, database, userName, pwd, ls);
        return ApiReturn.success();
    }
    ...
    public ApiReturn testConfig(@ApiParam("config")
        ...
        Setting set = JacksonUtils.readValue(config, Setting.class);
        // structService.testConfig(set);
        return ApiReturn.success();
    }
}
