...
INSERT INTO `repo_item` VALUES (1001, 'AutoDI', 'SUB_SYSTEM', 1, 1, 1, '企业级数据智能编排组件，提供拖拽配置、自然语言交互等方式，快速编排数据可视化大屏、智能分析面板、搜索系统等数据智能应用。', '{}', '[]');
INSERT INTO `repo_item` VALUES (1002, 'KGDP', 'SUB_SYSTEM', 1, 1, 1, '复杂文本加工组件，提供外部文档资源加工成结构化数据并入图的标注平台，支持篇、章、段拆解，支持半自动化实体、关系、属性等要素标注，支持加工结果入图。', '{\"url\":[{\"string\":\"/kgdp\"}]}', '[{\"checkType\":\"CONSUL\",\"content\":\"kgdp\"}]');
...
INSERT INTO `repo_item` VALUES (2001, 'KGSearch', 'SUB_SYSTEM', 2, 1, 1, '文本搜索引擎，提供基础的搜索能力，可通过增强软件包扩展搜索能力。', '{}', '[{\"checkType\":\"CONSUL\",\"content\":\"kgsearch\"}]');
...
INSERT INTO `repo_item` VALUES (11001, 'NLP Lab', 'SUB_SYSTEM', 11, 1, 1, 'NLP模型库，提供分词、命名实体识别、属性抽取、关系抽取、实体链接、关键词抽取、文本摘要生成等预构建模型。', '{\"url\":[{\"string\":\"/kgtext\"}]}', '[]');
...
INSERT INTO `repo_item` VALUES (902001, '模式自动规约软件包', 'DATA', 902, 1, 1, '集成自动规约计算模型，支持概念规约、属性规约的自动推荐，提供自底向上的知识模式自动构建方法，扩展知识建模能力。', '{}', '[{\"checkType\":\"FILE\",\"content\":\"/work/azkaban_shell/schema-transition.sh\"}]');
...
INSERT INTO `repo_item` VALUES (902004, '规则推理计算软件包', 'DATA', 902, 1, 1, '集成基于规则的推理模型，支持可视化配置推理参数、实时跟踪推理任务执行情况、查看推理结果并选择性入图。', '{}', '[{\"checkType\":\"FILE\",\"content\":\"/work/azkaban_shell/reasoning.sh\"}]');
INSERT INTO `repo_item` VALUES (902005, '神经网络推理计算软件包', 'DATA', 902, 1, 1, '集成基于神经网络的推理模型，支持可视化配置神经网络任务、实时跟踪推理任务执行情况、查看推理结果并选择性入图。', '{}', '[{\"checkType\":\"FILE\",\"content\":\"/work/azkaban_shell/nn-reasoning.sh\"}]');
INSERT INTO `repo_item` VALUES (902006, '离线数据接入软件包', 'DATA', 1001, 1, 1, '基于标准的结构化数据的知识图谱生成任务，提供模式映射到数据入图的调度配置并支持增量式数据构图。', '{}', '[{\"checkType\":\"FILE\",\"content\":\"/work/azkaban_shell/d2r.sh\"}]');
INSERT INTO `repo_item` VALUES (904004, '复杂图分析软件包', 'DATA', 904, 1, 1, '支持图谱的多种图计算的算法，包含Louvain、PageRank、TriangleCount、Closeness、Betweenness等，提供图计算结果可视化分析。', '{}', '[{\"checkType\":\"FILE\",\"content\":\"/work/azkaban_shell/graphx.sh\"}]');
...
INSERT INTO `repo_item` VALUES (1002001, 'MySQL', 'DATA', 1002, 1, 1, 'MySQL数据接入驱动，支持MySQL版本为5.1~5.7。', '{}', '[{\"checkType\":\"CONSUL\",\"content\":\"kgdw\"}]');
INSERT INTO `repo_item` VALUES (1002002, 'MongoDB', 'DATA', 1002, 1, 1, 'MongoDB数据接入驱动，支持MongoDB版本为3.6.10。', '{}', '[{\"checkType\":\"CONSUL\",\"content\":\"kgdw\"}]');
INSERT INTO `repo_item` VALUES (1002003, 'Oracle', 'DATA', 1002, 1, 1, 'Oracle数据接入驱动，支持Oracle版本为11.2。', '{}', '[{\"checkType\":\"CONSUL\",\"content\":\"kgdw\"}]');
