...
import ai.plantdata.kgcloud.domain.edit.req.basic.AbstractModifyReq;
import ai.plantdata.kgcloud.domain.edit.req.basic.AdditionalReq;
import ai.plantdata.kgcloud.domain.edit.req.basic.BasicReq;
import ai.plantdata.kgcloud.domain.edit.req.basic.ImageUrlReq;
import ai.plantdata.kgcloud.domain.edit.req.basic.PromptReq;
