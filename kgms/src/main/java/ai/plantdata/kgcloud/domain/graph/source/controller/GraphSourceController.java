package ai.plantdata.kgcloud.domain.graph.source.controller;

import ai.plantdata.cloud.bean.ApiReturn;
import ai.plantdata.kgcloud.domain.graph.source.req.GraphQueryReq;
import ai.plantdata.kgcloud.domain.graph.source.req.GraphSourceReq;
import ai.plantdata.kgcloud.domain.graph.source.rsp.GraphSourceRsp;
import ai.plantdata.kgcloud.domain.graph.source.service.GraphSourceService;
