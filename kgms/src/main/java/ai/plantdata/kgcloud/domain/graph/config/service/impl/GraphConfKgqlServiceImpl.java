...
import ai.plantdata.kgcloud.domain.graph.config.repository.GraphConfKgqlRepository;
import cn.hiboot.mcn.core.model.result.RestResp;
import ai.plantdata.kgcloud.domain.graph.config.entity.GraphConfKgql;
